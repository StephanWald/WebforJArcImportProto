...
WINDOW 1 "Connect Direct Process Return Information" 5 85 585 318
BEGIN
    ICON "Carit.ico"
    DIALOGBEHAVIOR
    INVISIBLE
    ...
    NAME "FrmCDReturnInfo"
    DEFAULTFONT "Microsoft Sans Serif" 9

    BUTTON 1, "OK", 355, 284, 60, 22
    BEGIN
        NAME "pbnOk"
    ...
    BEGIN
        ...
        GRIDCOLWIDTH 3, 75
        GRIDCOLTITLE 3, "Process now"
        NAME "gclCDReturnInfo"
        CLIENTEDGE
        FONT "Microsoft Sans Serif" 9
    END
