...
WINDOW 1 "Maintenance of Activity Time Search Codes" 5 85 510 266
BEGIN
    MENUBAR 101
    ICON "Carit.ico"
    INVISIBLE
    ...
    GROUPBOX 1000, "", -2, 24, 520, 10
    BEGIN
        NAME "gbxHeader"
        FONT "Microsoft Sans Serif" 9
    END

    GRID 11001, "", 5, 45, 497, 210
    BEGIN
        ROWS 5000
        COLUMNHEAD 20, 11002
        COLUMNS 2
        ...
        VSCROLLBAR
        GRIDCOLWIDTH 0, 175
        GRIDCOLTITLE 0, "Activity time search code"
        GRIDCOLWIDTH 1, 300
        GRIDCOLTITLE 1, "Description"
        NAME "gclActiseco"
        CLIENTEDGE
        SHORTCUE "The activity time search codes grid"
        FONT "Microsoft Sans Serif" 9
    END
END
